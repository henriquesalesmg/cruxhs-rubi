class ContatosController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @contato.save
   #     UserMailer.mensagem_de_confirmacao(@contato).deliver!
    #    UserMailer.notificacao(@contato).deliver!
     #   UserMailer.notificacao1(@contato).deliver!
   #     UserMailer.notificacao2(@contato).deliver!
    #    UserMailer.notificacao3(@contato).deliver!
  ...
  private
    ...
    def contato_params
      params.require(:contato).permit(:nome, :telefone, :email, :pedido, :mensagem)
    end
end
